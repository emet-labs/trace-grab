...
**Status:** Decided here; mirrored in [`sentinel/docs/adr/0029-corpus-data-is-a-distinct-class.md`](https://github.com/emet-labs/sentinel/blob/main/docs/adr/0029-corpus-data-is-a-distinct-class.md) ([sentinel#79](https://github.com/emet-labs/sentinel/issues/79)).
